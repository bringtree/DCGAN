...
def generator(random_number):
    ...
    with tf.variable_scope('generator_model'):
        with tf.variable_scope('deconvolute_pre_layer'):
            ...
            deconv_pre = tf.matmul(random_number, w)
        ...
        with tf.variable_scope('deconvolute_layer1'):
            ...
            deconv1 = tf.contrib.layers.batch_norm(deconv1, decay=0.9, updates_collections=None, epsilon=1e-5,
                                                   scale=True)
        ...
        with tf.variable_scope('deconvolute_layer2'):
            ...
            deconv2 = tf.contrib.layers.batch_norm(deconv2, decay=0.9, updates_collections=None, epsilon=1e-5,
                                                   scale=True)
        ...
        with tf.variable_scope('deconvolute_layer3'):
            ...
            deconv3 = tf.contrib.layers.batch_norm(deconv3, decay=0.9, updates_collections=None, epsilon=1e-5,
                                                   scale=True)
...
def discriminator(image, reuse=False):
    ...
    with tf.variable_scope('discriminator') as scope:
        ...
        with tf.variable_scope('convolute_layer1'):
            ...
            b1 = tf.get_variable('b1', shape=[64], dtype=tf.float32,
        ...
        with tf.variable_scope('convolute_layer3'):
            w3 = tf.get_variable('w3', shape=[5, 5, 128, 256], dtype=tf.float32,
                                 initializer=tf.truncated_normal_initializer(stddev=0.02))
            b3 = tf.get_variable('b3', shape=[256], dtype=tf.float32,
                                 initializer=tf.random_normal_initializer(stddev=0.0))
        ...
        with tf.variable_scope('convolute_layer4'):
            w4 = tf.get_variable('w4', shape=[5, 5, 256, 512], dtype=tf.float32,
                                 initializer=tf.truncated_normal_initializer(stddev=0.02))
            b4 = tf.get_variable('b4', shape=[512], dtype=tf.float32,
                                 initializer=tf.random_normal_initializer(stddev=0.0))
        ...
        with tf.variable_scope('convolute_layer5'):
            ...
            w5 = tf.get_variable('w5', shape=[8192, 1], dtype=tf.float32,
                                 initializer=tf.truncated_normal_initializer(stddev=0.02))
            b5 = tf.get_variable('b5', shape=[64], dtype=tf.float32,
                                 initializer=tf.random_normal_initializer(stddev=0.0))
